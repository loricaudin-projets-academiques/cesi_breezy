...
import { HttpMediaService } from './media/HttpMediaService';
...
// Ces services sont des singletons — une seule instance dans toute l'app.
...
export const mediaService: IMediaService = new HttpMediaService();
